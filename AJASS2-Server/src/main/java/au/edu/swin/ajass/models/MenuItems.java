...
import au.edu.swin.ajass.enums.*;
...
public final class MenuItems {
    ...
    private void parseMenuItem(String line) {
        ...
        try {
            ...
            placeItem(foodType, mealType, new MenuItem(itemName, price, energy, protein, carbs, fat, fibre, PLU));
     ...
     */
    private void placeItem(MenuItemType foodType, MealType mealType, MenuItem toPlace) {
