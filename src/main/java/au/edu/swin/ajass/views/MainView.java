...
public class MainView extends JFrame {
    ...
    public CustomerDetailsView getCustomerDetailsView() {
        return (CustomerDetailsView) customerDetails;
    }

    public ChooseMenuItemsView getChooseMenuItemsView() {
    ...
    public ChoiceNutritionInfoView getChoiceNutritionInfoView() {
        return (ChoiceNutritionInfoView) choiceNutritionInfo;
    }

    public OrderedItemsView getOrderedItemsView() {
