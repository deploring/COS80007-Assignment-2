...
public class OrderStatusView implements IView {
    ...
    public void updateTables() {
        ...
        main.getController().getMenuController().getTables().forEach(table -> {
            tableNo.addAndGet(1);
        ...
        if (main.getController().getMenuController().getNumberOfOrders(OrderState.WAITING) > 0)
        ...
        if (main.getController().getMenuController().getNumberOfOrders(OrderState.SERVED) > 0)
